          ...
          <div className='max-w-[450px] h-[600px] mx-auto bg-black/75 text-white text-center'>
            <div className='max-w-[320px] mx-auto py-16 '>
              ...
              <form onSubmit={handleSubmit} className='flex flex-col'>
                ...
                <p className='py-8'><span className='text-gray-400 mr-2'>New to Pipflix?</span><Link to='/signup'>Sign up</Link> </p>
              </form>
              <button onClick={Init} className='bg-blue-600 py-3 my-6 rounded font-bold mx-auto w-full'>Sign In with Google</button>
            </div>
          </div>
        </div>
      </div>
